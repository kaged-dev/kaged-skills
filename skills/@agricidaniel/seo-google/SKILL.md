---
description: "Google SEO APIs integration: Search Console, PageSpeed Insights v5, CrUX field data, Indexing API, and GA4 organic traffic. Provides real Core Web Vitals, indexation status, and search performance data."
---
